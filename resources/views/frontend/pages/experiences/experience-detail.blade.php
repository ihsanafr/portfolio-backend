...
<body class="bg-[url('{{ asset('assets/background/BG.png') }}')]">
    <main class="max-w-screen-lg mx-5 md:mx-10 lg:mx-auto ">
        ...
        <div>
            <p class=" text-2xl md:text-2xl text-green-400 font-medium">{{ $experience->date }}</p>
            <div class="h-[1rem]"></div>
            <p class="text-white text-xl md:text-3xl font-semibold">{{ $experience->name }} </p>
        </div>
        <div class="h-[3rem]"></div>


        <section class="bg-cover max-w-screen-lg h-[30rem]" style="background-image: url('{{ asset($experience->image) }}">
        </section>
        ...
        <div class="flex flex-col md:flex-row max-w-screen-lg gap-8">
            <div class="flex w-full  shadow-[#804CDF] flex-col rounded-xl">
                <div class="flex flex-col">
                    ...
                    <div class="h-[1rem]"></div>
                    <p class="text-md font-light text-white">{{$experience->overview}} </p>
                </div>
                <div class="h-[2rem]"></div>
                <div class="flex flex-col">
                    <p class="text-white font-semibold text-xl">Goals & Achievement</p>
                    <div class="h-[1rem]"></div>
                    <p class="text-md font-light text-white">{{$experience->goals_achievement}}</p>
